...
public class TerrariumV2 {
    ...
    public TerrariumV2(String eui, String userId, double minTemperature, double maxTemperature, double minHumidity, double maxHumidity, int maxCarbonDioxide) {
        this.eui = eui;
        this.userId = userId;
